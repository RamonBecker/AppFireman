...
public class TVistoria extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		btnSelecionar.setStyle("-fx-padding: 0.7em 0.57em; -fx-font-size: 14px;-jfx-button-type: RAISED;-fx-background-color: rgb(155, 10, 7);-fx-pref-width: 100;-fx-text-fill: WHITE;");
